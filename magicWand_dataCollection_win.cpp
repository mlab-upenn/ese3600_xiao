...
class CbServer : public NimBLEServerCallbacks {
  ...
  void onDisconnect(NimBLEServer*) {
    ...
    Serial.print("[BLE] Restarting advertising\r\n");
...
class CbCtrl : public NimBLECharacteristicCallbacks {
  void onWrite(NimBLECharacteristic* c) {
    ...
    if (v.size() > 0) {
      streamOn = (v[0] != 0);
      Serial.print("[CTRL] streamOn = ");
      Serial.print(streamOn ? 1 : 0);
...
void setup() {
  ...
  Serial.print("[BLE] Advertising as MagicWand with svc 0xFF00\r\n");
  Serial.print("========================================\r\n");
  Serial.print("[SETUP] Ready for connections!\r\n");
  Serial.print("========================================\r\n");
}
...
void loop() {
  ...
  try {
    ...
    Serial.print("[ERR] BLE notification failed\r\n");
  }
}